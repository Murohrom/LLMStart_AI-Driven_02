    ...
    async def message_handler(self, message: Message) -> None:
        ...
        if not user_text:
            ...
            await message.answer(
                "🎭 О, медиафайл! Как интересно... Но я специализируюсь на тексте и изображениях. "
                "Попробуй отправить мне текст или картинку, и я с удовольствием их проанализирую с сарказмом."
            )
            return
