...
| 9. Обработка изображений | ⏳ | - | - | - | В разработке |
...
- [ ] Добавить поддержку загрузки изображений в обработчики
- [ ] Интегрировать OpenCV для базовой обработки изображений
- [ ] Реализовать анализ изображений через облачные модели (OpenRouter)
- [ ] Добавить генерацию ответных изображений
- [ ] Оптимизировать размеры и форматы изображений
- [ ] Добавить валидацию типов файлов
- [ ] Создать команду `/image` для тестирования
